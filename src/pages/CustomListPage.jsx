				...
				{drinkData.drinks.reverse().map((index, idx) => (
					<div key={index} onClick={() => goToDetails(index)} className="sample">
						<div className="imageBox">
							<img
								src={
									index.strImageSource === 0
										? coc1
										: index.strImageSource === 1
										? coc2
										: index.strImageSource === 2
										? coc3
										: index.strImageSource === 3
										? coc4
										: index.strImageSource === null
										? coc1
						...
						<div className="textBox">
							...
							<div className="customsScript">
								...
								<button className="faHeart" onClick={() => handleLikeClick(index)}>
									<FontAwesomeIcon
										icon={isLiked[index] ? faSolidHeart : faHeart}
