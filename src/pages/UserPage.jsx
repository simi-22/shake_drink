		...
		<>
			...
			<Container maxWidth="lg">
				<Grid container spacing={2}>
					...
					<Grid item xs={12} md={6} lg={6}>
						<Box Container maxWidth="sm" sx={{ border: "2px solid grey", padding: "20px" }}>
							<div>
								<div
									style={{
										display: "flex",
					...
					<Grid item xs={12} md={6} lg={6}>
						<Container maxWidth="sm" sx={{ border: "2px solid grey", py: "10px" }}>
							<h3>Wish List</h3>
							<Checkbox
								checked={checked}
					...
					<Grid item xs={12} md={6} lg={6}>
						...
						<Container maxWidth="sm" sx={{ border: "2px solid grey", mt: "10px", py: "10px" }}>
							<div>
								<h3>Payment</h3>
